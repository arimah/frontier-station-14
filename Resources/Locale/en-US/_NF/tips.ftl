...
nf-tips-dataset-121 = If you want to stop somebody from escaping after uncuffing them, turn on combat mode while uncuffing - this will shove them down.
nf-tips-dataset-122 = Make sure to clean your illegal implanters with soap or a damp rag after you use them! Detectives can scan used implanters for incriminating DNA evidence, but not if they've been wiped clean.
